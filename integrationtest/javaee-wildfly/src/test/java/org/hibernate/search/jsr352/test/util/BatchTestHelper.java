...
public final class BatchTestHelper {
	 ...
	 * in an asynchronous way. Returns when either the job execution completes
	 * or we have polled the maximum number of tries.
	 *
	 ...
	 */
	public static JobExecution keepTestAlive(JobExecution jobExecution)
